...
Once you have created an Azure workspace and registered your components in the one-time setup above, you can execute the responsibleai via the CLI or SDK notebooks in the `notebooks` [folder](examples) in this repo.
