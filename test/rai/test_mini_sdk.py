...
class TestMiniSDK:
    ...
    def test_sdk_smoke(
        ...
        pipeline_inputs = {
            ...
            "my_training_data": JobInput(dataset=f"adult_train_pq:{version_string}", mode="download"),
            "my_test_data": JobInput(dataset=f"adult_test_pq:{version_string}", mode="download"),
        }
